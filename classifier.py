...
def codeLabels(yTrain, disorder): #ABIDE, ADHD, PTSD, ADNI
    if disorder == "ADNI":
...
path = os.getcwd()
trainPath = os.getcwd()+ "Data/" +age+"/"+ disorder + "_train_data.xlsx"
testPath  = os.getcwd()+ "Data/" +age+"/"+ disorder + "_test_data.xlsx"
...
codeLabels(yTrain, disorder = disorder)
